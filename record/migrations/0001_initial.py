# Generated by Django 3.1.3 on 2021-01-30 13:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spouse', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='record.person')),
            ],
        ),
        migrations.CreateModel(
            name='Ownership',
            fields=[
                ...
                ('previous', models.FloatField(blank=True, max_length=255)),
